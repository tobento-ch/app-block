...
class MailEditorFactoryTest extends TestCase
{
    ...
    public function testBlockFactoryMethod()
    {
        ...
        $this->assertSame('mail', $this->createEditorFactory()->blockFactory()->viewNamespace());
    }
